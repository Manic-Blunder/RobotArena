...
class ZoonerNeat(maxGenomes: Int, minGenomes: Int) : Neat(19, 0, 0, 4, maxGenomes, minGenomes) {
    init {
        ...
        excessCoefficient = 0.25 // how much excess connections count against genome similarity
        ...
        mutateConnectionChance = 1.0 // chance to form a new connection between two nodes. The new connection will have a random weight
        ...
        mutateDropConnectionChance = 0.5 // chance to drop a connection
        weightShiftPower = 0.1 // how much the weight can shift
        weightRandomPower = 0.2 // range of the new weight
